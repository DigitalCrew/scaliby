...
/*ALTERED*/    var MONTHS,
/*ALTERED*/        SHORT_MONTHS,
/*ALTERED*/        DAYS_OF_WEEK,
/*ALTERED*/        SHORT_DAYS,
        EX_KEYS = [9,112,113,114,115,116,117,118,119,120,121,122,123],
        DCAL_DATA = '_duDatepicker',
/*ALTERED*/        SELECTED_FORMAT, MONTH_HEAD_FORMAT,

        DUDatePicker = function(elem, options) {

/*ALTERED*/    MONTHS = Scaliby.getConfiguration().messages.datepicker.months,
/*ALTERED*/    SHORT_MONTHS = Scaliby.getConfiguration().messages.datepicker.shortMonths,
/*ALTERED*/    DAYS_OF_WEEK = Scaliby.getConfiguration().messages.datepicker.weekDays,
/*ALTERED*/    SHORT_DAYS = Scaliby.getConfiguration().messages.datepicker.shortDays,
/*ALTERED*/    SELECTED_FORMAT = Scaliby.getConfiguration().messages.datepicker.selectedFormat, MONTH_HEAD_FORMAT = Scaliby.getConfiguration().messages.datepicker.monthHeadFormat;
            var that = this;
...
/*ALTERED*/                        btnClear: $('<span class="dudp__button clear">' + Scaliby.getConfiguration().messages.button.clear + '</span>'),
/*ALTERED*/                        btnCancel: $('<span class="dudp__button cancel">' + Scaliby.getConfiguration().messages.button.cancel + '</span>'),
    ...
    DUDatePicker.prototype = {
        ...
        setupPicker: function () {
            var that = this,
/*ALTERED*/                picker = that.datepicker,
        ...
        setupCalendar: function () {
            ...
            var inView = {
                ...
                weekDays: $('<div class="dudp__weekdays"><span>Do</span><span>Se</span><span>Te</span><span>Qu</span><span>Qu</span><span>Se</span><span>Sa</span></div>'),
...
/*ALTERED*/                calViews = picker.calendarHolder.calendarViews.wrapper,
            _animDuration = 250;
        ...
        setValue: function (value) {
            ...
            if (typeof value === 'string') {
                if (value === '' || value.length !== this.config.format.length) {
                    invalid = true;
                }
                date = this.parseDate(value, this.config.format).date
            } else {
                date = value;
            }

            var formatted = this.formatDate(date, this.config.format);
            this.date = date;
        ...
        parseDate : function (date, dateFormat) {
            ...
            if (date === '' || date.length !== that.config.format.length) {
                return {m: null, d: null, y: null, date: new Date()};
            }
        ...
        formatDate : function (date, format) {
            ...
            return format.replace(/(yyyy|yy|mmmm|mmm|mm|m|DD|D|dd|d\s)/g, function (e) {
                switch(e) {
    ...
    $.fn.duDatepicker = function (config, param) {
        return $(this).each(function (idx, el) {
            var that = this,
                $that = $(this),
/*ALTERED*/                picker = $(this).data(DCAL_DATA),
            ...
            if(typeof config === 'string') picker[config](param);
